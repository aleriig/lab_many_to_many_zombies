...
zombie_repository.select_all()
zombie_type_repository.select_all()
...
human_repository.select(human_1.id)
zombie_repository.select(zombie_2.id)
zombie_type_repository.select(zombie_type_3.id)
biting_repository.select(biting_1.id)

biting_repository.update
